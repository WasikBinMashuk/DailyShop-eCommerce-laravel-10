          ...
          <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div>
                        <input type="text" class="form-control" name="name" placeholder="Enter name" value="{{ $editUsers->name }}">
                        @error('name')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div>
                        <input type="email" class="form-control" name="email"  placeholder="Enter email"value="{{ $editUsers->email }}">
                        @error('email')
                                <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div>
                        <input type="text" class="form-control" name="mobile" placeholder="Enter mobile no" value="{{ $editUsers->mobile }}">
                        @error('mobile')
                                <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div>
                    <select name="status" class="form-select">
                      <option value="1" {{ $editUsers->status == '1' ? 'selected' : '' }}>Active</option>
                      <option value="0" {{ $editUsers->status == '0' ? 'selected' : '' }}>Inactive</option>
                    </select>
                  </div>
                </div>
