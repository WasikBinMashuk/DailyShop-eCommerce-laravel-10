                                    ...
                                    <figure class="product-main-image">
                                        @if ($product->product_image)
                                            <img src="{{ asset('images/' . $product->product_image) }}" alt="Product image"
                                                class="product-image" style="height: 280px;width:280px;">
                                        @else
                            ...
                            <div class="product-details">
                                ...
                                <form action="{{ route('add_to_cart_from_product', $product->id) }}" method="POST">
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <button type="submit"
                                            class="btn-product btn-cart"><span>{{ __('text.add to cart') }}</span></button>
                                ...
                                <div class="product-details-footer">
                                    <div class="product-cat">
                                        <span>Category: {{ $product->category_name }} >
                                            {{ $product->sub_category_name }}</span>
                    ...
                    @foreach ($relatedProducts as $item)
                        <div class="product product-7 text-center">
                            ...
                            <div class="product-body">
                                <div class="product-cat">
                                    <a href="#"><span>Category: {{ $item->category_name }} >
                                            {{ $item->sub_category_name }}</span></a>
                                </div><!-- End .product-cat -->
