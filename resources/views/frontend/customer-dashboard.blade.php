                            ...
                            <ul class="nav nav-dashboard flex-column mb-3 mb-md-0" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab-dashboard-link" data-toggle="tab"
                                        ...
                                        aria-selected="true">{{ __('text.Profile') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-orders-link" data-toggle="tab" href="#tab-orders"
                                        role="tab" aria-controls="tab-orders"
                                        aria-selected="false">{{ __('text.Orders') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-address-link" data-toggle="tab" href="#tab-address"
                                        role="tab" aria-controls="tab-address"
                                        aria-selected="false">{{ __('text.Address') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-account-link" data-toggle="tab" href="#tab-account"
                                        role="tab" aria-controls="tab-account"
                                        aria-selected="false">{{ __('text.Change Password') }}</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="tab-content">
                                    ...
                                    @foreach ($orders as $order)
                                        <div class="row p-2 bg-white border rounded mt-2">
                                            <div class="col-md-6 mt-1">
                                                <h5 style="color: orange">{{ __('text.Order ID.') }} {{ $order->id }}
                                                </h5>
                                            ...
                                            <div class="align-items-center align-content-center col-md-6 border-left mt-1">
                                                <div class="d-flex flex-row align-items-center">
                                                    <h4 class="mr-1" style="color: orange">{{ __('text.Total Price') }}:
                                                        <span class="text-dark">&#2547;{{ $order->subtotal }}</span>
                                                    </h4>
                                                </div>
                                                <div class="d-flex flex-column mt-4">
                                                    <span class="badge bg-light h5 "
                                                        style="height: 30px; ">{{ __('text.Order Status') }}</span>

                                                    @if ($order->status == 1)
                                                        <span class="badge  h5 "
                                                            style="height: 30px; background-color:rgb(157, 103, 2)">Processing</span>
                                                    @elseif ($order->status == 2)
                                                        <span class="badge  h5 "
                                                            style="height: 30px; background-color:rgb(245, 192, 93)">Shipped</span>
                                                    @elseif ($order->status == 3)
                                                        <span class="badge  h5 "
                                                            style="height: 30px; background-color:rgb(0, 144, 29)">Delivered</span>
                                                    @else
                                                        <span class="badge  h5 "
                                                            style="height: 30px; background-color:rgb(255, 43, 43)">Failed</span>
                                                    @endif
                                ...
                                <div class="tab-pane fade" id="tab-address" role="tabpanel"
                                    ...
                                    <p>{{ __('text.The following addresses will be used on the checkout page by default') }}
                                    </p>

                                    <div>
                                        <div class="card card-dashboard">
                                            <div class="card-body">
                                                <h3 class="card-title">{{ __('text.Shipping Address') }}</h3>
                                                <!-- End .card-title -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="text" name="postcode" class="form-control"
                                                                value="{{ $profile->postcode }}" required>
                                                            @error('postcode')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div><!-- End .col-sm-6 -->
                                ...
                                <div class="tab-pane fade" id="tab-account" role="tabpanel"
                                    ...
                                    <form action="{{ route('customer.change.password') }}" method="POST">
                                        @csrf
                                        <div>
                                            <label>{{ __('text.Old password') }}
                                                ({{ __('text.leave blank to leave unchanged') }})</label>
