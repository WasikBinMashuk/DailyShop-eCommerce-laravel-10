                                    ...
                                    @if (session('cart'))
                                        @foreach (session('cart') as $id => $details)
                                            ...
                                            <tr data-id={{ $id }} id={{ $id }}>
                                                ...
                                                <td data-th="Total" class="total-col">
                                                    &#2547;{{ $details['price'] * $details['quantity'] }}</td>
                                                <td class="remove-col"><button class="btn-remove cart_remove"><i
                        ...
                        <aside class="col-lg-3">
                            <div class="summary summary-cart">
                                ...
                                <a href="{{ route('checkout') }}"
                                    class="btn btn-outline-primary-2 btn-order btn-block">{{ __('text.PROCEED TO CHECKOUT') }}</a>
                            </div><!-- End .summary -->

                            <a href="{{ route('shop') }}"
                                class="btn btn-outline-dark-2 btn-block mb-3"><span>{{ __('text.CONTINUE SHOPPING') }}</span><i
